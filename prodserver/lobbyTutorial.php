...
<head>
	...
	@font-face {
    		...
    		src: url('http://descentofchampions.com/autumn__-webfont.woff') format('woff');
    		font-weight: normal;
    		font-style: normal;
	}
...
if(isPortrait)
  ...
  if(buttonClickCount == tutorialTextPosition.length)
  	window.location.href = "streamTutorial";
  else
  {
...
<img id = "tutorialImg" src="WebsiteArt/Tutorial/Step1.png"/>
...
<input style="visibility: hidden;" id="deletePicture" type="image" src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Wheel_cross.svg/1024px-Wheel_cross.svg.png" name="deleteForm" class="btTxt submit"/>

...
<ul id="myUL">
	...
	<li>
			...
			<div class = "priceTag" id = "price1"><p>$3k</p></div>
  			...
  			<div class = "timeout" id = "timeout1">10000</div>
  			</div>
	...
	<li>
  			...
  			<div class = "timeout" id = "timeout2">10000</div>
  			</div>
	...
	<li>
  			...
  			<div class = "timeout" id = "timeout3">10000</div>
  			</div>
	...
	<li>
  			...
  			<div class = "timeout" id = "timeout5">10000</div>
  			</div>
	...
	<li>
  			...
  			<div class = "timeout" id = "timeout6">10000</div>
  			</div>
	...
	<li>
  			...
  			<div class = "timeout" id = "timeout7">10000</div>
  			</div>
	...
	<li>
  			...
  			<div class = "timeout" id = "timeout8">10000</div>
  			</div>
	...
	<li>
  			...
  			<div class = "timeout" id = "timeout9">10000</div>
  			</div>

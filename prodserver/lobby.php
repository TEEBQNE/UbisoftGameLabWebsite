...
<head>
	...
	window.onload = sortList;
	 ...
	 jQuery(function startServer(){
			...
			websocket_server = new WebSocket("ws://13.71.165.236:8080/");	
...
<input style="visibility: hidden;" onclick="deleteAccount(); location.href='reset';"id="deleteAccount" type="image" src="WebsiteArt/DeleteAccount.png" name="deleteName" class="btTxt submit"/>
<p style="visibility: hidden;" class = "settingsText" id = "deleteAccountText">Delete Account</p>
</div>

<div id = "changeNameBlock">
<input style="visibility: hidden;" onclick="changeName(); location.href='change';"id="changeName" type="image" src="WebsiteArt/ChangeName.png" name="changeName" class="btTxt submit"/>
<p style="visibility: hidden;" class = "settingsText" id = "changeNameText">Change Name</p>
</div>

<div id = "goToTutorialBlock">
<input style="visibility: hidden;" onclick="location.href='lobbyTutorial';" id="goToTutorial" type="image" src="WebsiteArt/TutorialIcon.png" name="changeName" class="btTxt submit"/>
...
?>
	<div class = "container">
	<li>
  			<div class="username"><a href="http://descentofchampions.com/index.php/stream/<?php echo $row['streamerName']?>"><span><?php echo $row['streamerName']."<br>"?></span></a></div>
  			<div class = "userPicture"><a href="http://descentofchampions.com/index.php/stream/<?php echo $row['streamerName']?>"><img onclick="showClick(this)" id ="userPhoto" src="<?php echo $row['streamerProfilePic']?>"></a></div>

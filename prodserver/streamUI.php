<?php
	...
	else
	{
		...
		echo '<meta http-equiv="refresh" content="0; URL=http://descentofchampions.com">';
		exit;
	}
?>
...
<body>
	<div class = "UIBanner">
		...
		<input onclick="toggleIcons(1)"id ="backButton" type="image" src="WebsiteArt/BackButton.png" name="backButton" class="btTxt submit"/>

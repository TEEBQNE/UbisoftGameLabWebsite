...
<head>
	...
	*
	...
	/* As the blur pass messes with the stack ordering, I had to get creative */
	...
	/* allows for scalable dynamic image on screen */
	/* desktop */
	#tutorialImg
	{
...
<script>
// preload images to fix the flickering of images
...
// determine device to fix tutorial layout (iPhones task bar, android, desktops are huge)
var userAgent = navigator.userAgent || navigator.vendor || window.opera;
if (/android/i.test(userAgent)) {
var tutorialImageSrcArray = ["Step6.png", "Step7.png", "Step8.png", "Step9.png", "Step10.png", "Step11.png", "Step12.png", "Step13.png"];
...
if(e.type == 'touchstart')
{
        ...
        {
        		// prevents the 'ghost' click on mobile to skip pictures
                e.stopPropagation();
                return false;
        });
}
if(isPortrait)
  ...
  // if they reached the max, then go back to the lobby
  if(buttonClickCount == tutorialImageSrcArray.length)
  	window.location.href = "lobby";
  else
  {

	// set the new blur information based on array data
	...
	// set the new photo, position and blur information
  ...
  // prevents ghost click on mobile to skip pictures
  e.stopPropagation();
  e.preventDefault();
  return false;
};
